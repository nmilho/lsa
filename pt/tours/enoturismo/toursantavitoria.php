...
<head>
    ...
    <title>Land&Sea Alentejo | Roteiros: Tour Enoturismo - Casa Santa Vitória</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <!-- Heading -->
                            <h2 class="title dark-grey-text">Tour Casa SantaVitória</h2>

                            <div class="card card-image" style="background: url(/photos/tours/enoturismo/santavitoria/santavitoria06.jpg) -0px -250px; background-size: 1110px; height: 300px;">
                    ...
                    <p class="text-left">Fundada em 2002, e fruto de uma paixão pelos produtos ligados à terra, esta empresa representa um investimento que pretende proporcionar um contato direto com o que de melhor se produz no Alentejo.</p>
                    <p class="text-left">A Santa Vitória oferece grandes vinhos, uma cuidada oferta de gastronomia regional e inúmeras atividades lúdicas disponíveis ao público em geral. Tudo isto em plena planície alentejana, num ambiente marcadamente rural.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <figure class="figure">
                                <img src="/photos/tours/enoturismo/santavitoria/santavitoria05.jpg" height="" class="img-fluid rounded z-depth-1">
                        ...
                        <div class="col-md-4">
                            ...
                            <figure class="figure">
                                <img src="/photos/tours/enoturismo/santavitoria/santavitoria08.jpg" height="230" class="img-fluid rounded z-depth-1">
                                <figcaption class="figure-caption">A Loja</figcaption>
                            </figure>
                        ...
                        <div class="col-md-4">
                            ...
                            <figure class="figure">
                                <img src="/photos/tours/enoturismo/santavitoria/santavitoria03.jpg" height="230" class="img-fluid rounded z-depth-1">
