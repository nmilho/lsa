...
<head>
    ...
    <title>Land&Sea Alentejo | Roteiros: Enoturismo</title>
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-center h-100">
                        ...
                        <div class="row d-flex justify-content-center text-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- Heading -->
                                <h2 class="display-3 font-weight-bold white-text mb-2">Roteiros Enoturismo</h2>

                                <!-- Divider -->
                                <hr class="hr-light">

                                <!-- Description -->
                                <h4 class="white-text my-4">O turismo ideal para quem gosta de bom vinho.</h4>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-5">
                            <h2 class="title dark-grey-text">Roteiros Enoturismo</h2>
                            <h4 class="dark-grey-text">Venha brindar connosco!!</h4>
                        </div>
                        <!--/.Column-->
                        ...
                        <div class="col-md-12 mb-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourfigueirinha.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourrocim.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourquetzal.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourribafreixo.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourvidigueira.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourmingorra.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourmalhadinha.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="tourgrous.php" class="nav-link">
                                ...
                                <!-- Card -->
                                <div class="col-md-4 col-sm-6">
                                    <a href="toursantavitoria.php" class="nav-link">
